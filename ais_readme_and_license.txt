...
How to use:
-	copy the ais_injruy folder, the init and the description.ext into your own mission folder
-	setup the setup_ais.sqf data in the ais_injury folder if needed
-------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------
...
-	setup file to change some parameters if needed
-	injury state without being realy death
-	compatible for missions without repsawn
-	drag, carry and drop injury units
-	change the damage tolerance of your units
-	optical bleeding effects
-	unconcious units are able to roll on their jelly (press "forward") and empty their magazine
-	if a unconcious unit start shooting again the enemys will fight him too (until he died)
-	unconcious units arent able to walk, trowh grenades, reload, ...
-	a player who starts the healing process can abort the healing by pressing "backward" if needed (maybee under fire)
-	markers show injury units on the map
-	3D icons show injury units ingame within a circle of 30 metres
-	progress of healing is visualized (progess bar)
-	diffrent states of health after a unit becomes first aid (depends on healer role and equipment... FAK's & Medikits)
...
-	if you start healing process during handle a rocket launcher you cant abort the process until is finished
